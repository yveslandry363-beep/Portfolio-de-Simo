...
// RESTORED: Curated High-End Imagery for Hover Effect
const IMAGES = {
    work: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop",
    philosophy: "https://images.unsplash.com/photo-1506784365847-bbad939e9335?q=80&w=2668&auto=format&fit=crop",
    footer: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2670&auto=format&fit=crop"
};
...
const MenuOverlay: React.FC<MenuOverlayProps> = ({ isOpen, onClose, links, onNavClick }) => {
    ...
    return (
        <Portal>
            <div
                ref={containerRef}
                className="fixed inset-0 z-[99999] bg-[#050505] text-white flex flex-col opacity-0"
                style={{ pointerEvents: 'none' }} // Managed by GSAP, but defaults to safe
            >
                {/* 
                    CLOSE BUTTON 
                    - FORCE z-index: 100000 
                    - FORCE pointer-events: auto 
                    - Fixed positioning relative to window to escape any overflow issues
                */}
                <button
                    onClick={(e) => {
                    ...
                    className="fixed top-8 right-8 md:top-12 md:right-12 p-6 bg-white text-black rounded-full z-[100002] cursor-pointer hover:scale-110 active:scale-90 transition-transform shadow-2xl hover:bg-gray-200 group"
                ...
                <div className="absolute top-12 left-12 text-xs font-mono text-gray-500 uppercase tracking-widest z-[100001]">
                    Navigation
                </div>

                <div className="flex-1 flex flex-col justify-center w-full relative z-[100000]">
                        ...
                        {links.map((link, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={(e) => {
                                        console.log("Nav clicked:", link.id);
                                        // Ensure pointer-events are allowed for this click
                                        onNavClick(e, link.id);
                                    }}
                                    style={{ pointerEvents: 'auto' }} // FORCE CLICKABILITY per row
                                >
                                    ...
                                    {/* HOVER REVEAL EFFECT (Marquee + Image) */}
                ...
                <div className="p-12 flex justify-between items-end text-gray-500 font-mono text-sm uppercase tracking-widest relative z-[100001]">
